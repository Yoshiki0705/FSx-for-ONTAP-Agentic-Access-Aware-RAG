...
<!-- i18n:abridged -->
> **⚠️ Traducción parcial**: esta traducción cubre solo una parte del original japonés. Consulte la [versión japonesa](../auth-and-user-management.md) para el contenido completo.
...
![Página de inicio de sesión (Híbrido SAML + OIDC)](../screenshots/signin-page-saml-oidc-hybrid.png)

![Página de inicio de sesión Auth0 OIDC](../screenshots/oidc-auth0-login-page.png)

![Página de chat después del inicio de sesión OIDC exitoso](../screenshots/oidc-auth0-signin-success.png)
...
- [demo-data/guides/ontap-setup-guide.md](../../demo-data/guides/ontap-setup-guide.md) — Configuración de integración AD de FSx for ONTAP
