# Guía de Grabación de Video de Demostración de Verificación

**🌐 Language:** [日本語](../demo-recording-guide.md) | [English](../en/demo-recording-guide.md) | [한국어](../ko/demo-recording-guide.md) | [简体中文](../zh-CN/demo-recording-guide.md) | [繁體中文](../zh-TW/demo-recording-guide.md) | [Français](../fr/demo-recording-guide.md) | [Deutsch](../de/demo-recording-guide.md) | **Español**

**Última actualización**: 2026-03-29  
**Propósito**: Guía paso a paso para grabar videos de demostración de verificación del sistema Permission-Aware RAG  
**Requisitos previos**: Cuenta de AWS (equivalente a AdministratorAccess), instancia EC2 (Ubuntu 22.04, t3.large o superior, 50GB EBS)

---

## Evidencias a grabar (6 elementos)

| # | Evidencia | Contenido |
|---|-----------|-----------|
| (1) | Construcción de una plataforma de chatbot IA basada en RAG | Explicación de la arquitectura |
| (2) | Despliegue de la plataforma de chatbot usando AWS CDK | Procedimiento de despliegue CDK |
| (3) | Colocación de datos de almacenamiento en volúmenes FSx for ONTAP | Ingesta de datos a través de S3 Access Point |
| (4) | Reflejo de información de permisos de acceso | Configuración y verificación de información SID en `.metadata.json` |
| (5) | Determinación del acceso a datos basado en permisos por usuario | Verificación de filtrado SID |
| (6) | Verificación inicial | Verificación de UI de tarjetas, modo KB/Agent y visualización de citas |
...
### Instalación de herramientas requeridas en EC2
...
## Evidencia (1): Construcción de una plataforma de chatbot IA basada en RAG

**Contenido de grabación**: Explicación de la arquitectura del sistema
