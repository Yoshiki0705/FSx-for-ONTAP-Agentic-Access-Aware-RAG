...
<!-- i18n:abridged -->
> **⚠️ Traducción parcial**: esta traducción cubre solo una parte del original japonés. Consulte la [versión japonesa](../fsxn-sizing-and-performance.md) para el contenido completo.
