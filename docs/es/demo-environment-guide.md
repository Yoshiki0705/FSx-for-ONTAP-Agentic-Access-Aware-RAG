# Guía del Entorno de Verificación de RAG con Permisos

**🌐 Language:** [日本語](../demo-environment-guide.md) | [English](../en/demo-environment-guide.md) | [한국어](../ko/demo-environment-guide.md) | [简体中文](../zh-CN/demo-environment-guide.md) | [繁體中文](../zh-TW/demo-environment-guide.md) | [Français](../fr/demo-environment-guide.md) | [Deutsch](../de/demo-environment-guide.md) | **Español**
...
| Usuario | Dirección de correo | Contraseña | Rol | Permisos |
|---|---|---|---|---|
| Administrador | `admin@example.com` | `DemoAdmin123!` | administrator | Puede ver todos los documentos |
| Usuario general | `user@example.com` | `DemoUser123!` | user | Solo documentos públicos |

La autenticación es gestionada por Amazon Cognito.
...
## 3. Escenarios de verificación

### Flujo básico

1. Acceder a la URL de CloudFront → `/ja/signin`
2. Iniciar sesión con un usuario de prueba
3. **Modo KB**: Seleccionar un modelo en la pantalla de chat → Verificar el filtrado de permisos en la búsqueda RAG
4. **Modo Agent**: Hacer clic en el botón "🤖 Agent" en el encabezado → Seleccionar un Agent → Elegir un flujo de trabajo o chat libre

### Verificación de diferencias de permisos

Cuando el administrador y el usuario general hacen la misma pregunta, el filtrado SID devuelve resultados diferentes.
Los mismos controles de permisos se aplican tanto en el modo KB como en el modo Agent.
