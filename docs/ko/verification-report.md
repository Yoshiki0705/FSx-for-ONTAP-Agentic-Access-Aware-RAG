...
| 전송된 모델 | 변환 대상 | 이유 |
|------------|----------|------|
| `apac.amazon.nova-pro-v1:0` | `jp.amazon.nova-2-lite-v1:0` | DEPRECATED_MODEL_MAP에 의한 자동 리다이렉트 |
| `us.anthropic.claude-3-5-sonnet-20241022-v2:0` | `anthropic.claude-sonnet-4-6` | DEPRECATED_MODEL_MAP에 의해 Sonnet 4.6으로 리다이렉트 |
