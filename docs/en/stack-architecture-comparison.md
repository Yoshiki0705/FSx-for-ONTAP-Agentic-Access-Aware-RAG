...
| Advanced Permission Control | Time-based access control + permission decision audit log | `enableAdvancedPermissions=true` | `permission-audit` DynamoDB table + GSI |
