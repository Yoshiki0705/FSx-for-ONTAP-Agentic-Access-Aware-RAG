 ...
 * ```
 */
export class BedrockAgentCorePolicyConstruct extends Construct {
  /**
   * ポリシー保存用S3バケット
   */
  public readonly policyBucket: s3.Bucket;
   ...
   * ポリシー管理Lambda関数
   */
  public readonly policyFunction?: lambda.Function;
   ...
   */
  public grantPolicyBucketAccess(grantee: iam.IGrantable): iam.Grant {
   ...
   */
  public grantPolicyTableAccess(grantee: iam.IGrantable): iam.Grant {
   ...
   */
  public grantAuditLogTableAccess(grantee: iam.IGrantable): iam.Grant | undefined {
    if (this.auditLogTable) {
