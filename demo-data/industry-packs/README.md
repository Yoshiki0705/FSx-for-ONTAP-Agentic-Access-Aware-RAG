...
| [manufacturing/](./manufacturing/) | 5 | 製造業 |
| [construction/](./construction/) | 5 | 建設・AEC |
| [education/](./education/) | 5 | 教育・大学 |
| [insurance/](./insurance/) | 5 | 保険 |
| [manufacturing/](./manufacturing/) | 5 | 製造業 |
| [construction/](./construction/) | 5 | 建設業 |
| [education/](./education/) | 5 | 教育・大学 |
| [insurance/](./insurance/) | 5 | 保険業 |
...
### Manufacturing（製造業）パック

| SID 末尾 | グループ名 | 説明 |
|----------|-----------|------|
| `-5100` | 品質管理部 | 品質検査レポート、設備保全記録にアクセス |
| `-5200` | 生産管理部 | 生産計画、設備保全記録にアクセス |

### Construction（建設）パック

| SID 末尾 | グループ名 | 説明 |
|----------|-----------|------|
| `-6100` | 設計部 | BIM モデル、現場進捗報告にアクセス |
| `-6200` | 工事管理部 | 下請業者評価、現場進捗報告にアクセス |

### Education（教育）パック

| SID 末尾 | グループ名 | 説明 |
|----------|-----------|------|
| `-7100` | 情報工学研究室 | 科研費申請、研究室設備台帳にアクセス |
| `-7200` | 教務課 | 成績評価基準にアクセス |

### Insurance（保険）パック

| SID 末尾 | グループ名 | 説明 |
|----------|-----------|------|
| `-8100` | 損害査定部 | 査定ガイドライン、苦情対応マニュアルにアクセス |
| `-8200` | 不正対策室 | 不正請求検知パターンにアクセス |
...
### Construction（建設業）パック

| SID 末尾 | グループ名 | 説明 |
|----------|-----------|------|
| `-6100` | 設計部 | BIMモデル改訂履歴、現場進捗報告にアクセス |
| `-6200` | 工事管理部 | 下請業者評価、現場進捗報告にアクセス |
...
| SID 末尾 | グループ名 | 説明 |
|----------|-----------|------|
| `-7100` | 情報工学研究室 | 科研費申請書、研究室設備台帳にアクセス |
| `-7200` | 教務課 | 成績評価基準等の教務文書にアクセス |
